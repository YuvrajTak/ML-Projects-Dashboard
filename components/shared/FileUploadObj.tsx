...
export default function FileUploadObj() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      let url = `${process.env.NEXT_PUBLIC_BASE_URL}/upload-object-detect`
  ...
  return (
    <div className="min-h-screen w-full bg-[#121417] flex items-center rounded-3xl justify-center">
